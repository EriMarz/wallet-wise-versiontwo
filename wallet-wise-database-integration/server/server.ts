...
import adventureRouter from './routes/adventureRoutes';
...
const app = express();
const PORT = process.env.PORT || 3000; // 5432 this is the port in .env
...
app.get(
  '/api/adventures',
  adventureController.getAllAdventuresQuery,
  (req: Request, res: Response) => {
    return res.status(200).json(res.locals.allAdventures);
  }
);
